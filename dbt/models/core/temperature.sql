...
select stg_temperature.*, stations_unioned.Stationsname, stations_unioned.Breite, stations_unioned.Laenge,
stations_unioned.Stationshoehe, stations_unioned.Bundesland from stg_temperature
